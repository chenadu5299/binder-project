...
> 说明：本文是总开发方案文档。凡涉及层次三对话编辑的协议、状态、提示词、diff、生效与失效规则，一律以 [对话编辑-主控设计文档.md](/Users/chenzhenqiang/Desktop/test/binder-project/docs/对话编辑-主控设计文档.md)、[对话编辑-统一整合方案（待确认版）.md](/Users/chenzhenqiang/Desktop/test/binder-project/docs/对话编辑-统一整合方案（待确认版）.md)、[层次三（对话编辑）提示词详细分析文档.md](/Users/chenzhenqiang/Desktop/test/binder-project/docs/层次三（对话编辑）提示词详细分析文档.md) 为准。本文中旧的层次三规划、`workPlan`、独立规划工具相关描述不再作为当前实现依据。
