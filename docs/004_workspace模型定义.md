...
| ResourceNode | 资源区对象抽象（记忆/历史等） | `resourceType`、`resourceId`、`scope` |
...
1. 来源文档：  
- `Workspace改造可落地实施方案.md`（结构与主流程）  
- `资源管理需求文档.md`（资源对象语义与交互域）  

2. 对齐文档：  
- `001_产品定义总纲.md`（MVP 边界）  
- `对话编辑-统一整合方案.md`（编辑执行规则）  
- `文档逻辑状态传递规范.md`（L/baseline/revision 语义）  
