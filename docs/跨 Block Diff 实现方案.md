...
> 与主控关系：对话编辑区间协议以 [对话编辑-主控设计文档.md](/Users/chenzhenqiang/Desktop/test/binder-project/docs/对话编辑-主控设计文档.md) 为主轴；区间关系、失效、接受规则以 [对话编辑-统一整合方案（待确认版）.md](/Users/chenzhenqiang/Desktop/test/binder-project/docs/对话编辑-统一整合方案（待确认版）.md) 为执行底稿。本文只定义跨 Block 区间的专项实现口径。
