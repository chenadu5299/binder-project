...
- 文档属性：`参考`
- 主责模块：`DE`
- 文档职责：`层次一（辅助续写）提示词详细分析文档 / 参考、研究或索引文档`
...
- **更新日期**：2026年3月
- **文档性质**：提示词工程分析文档
- **适用范围**：Binder 层次一（辅助续写）功能提示词优化
- **关联规范**：`R-DE-M-R-08_辅助续写悬浮卡实现规范.md`（幽灵文字已放弃，悬浮卡 + AI 一次返回 3 条）
...
**当前限制**：1-80 字符（字=字符，即 character）

**说明**：每条续写建议最多 80 字符，以完整句子或完整语义单元结尾。
