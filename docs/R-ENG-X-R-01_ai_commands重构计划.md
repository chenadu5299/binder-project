...
- 文档属性：`参考`
- 主责模块：`ENG`
- 文档职责：`ai_commands重构计划 / 参考、研究或索引文档`
...
根据《R-DE-M-R-01_对话编辑-主控设计文档.md》《对话编辑-统一整合方案（待确认版）.md》《R-DE-M-R-13_层次三（对话编辑）提示词详细分析文档.md》，将当前的 `ai_commands.rs` 重构为与新对话编辑主链一致的模块化架构。
